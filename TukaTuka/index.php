                                                ...
                                                <article class="box excerpt">
                                                    <a class="image left" href="news/09.04.18.html#main-wrapper"><img src="images/26.jpg" class="d-none d-md-block" style="width:260px; height: 278px;" alt="Вторичные переработанные гранулы" /><img src="images/26.jpg" class="d-md-none" style="width:85px; height: 85px;" alt="Вторичные переработанные гранулы" /></a>
														<div>
                                                            ...
                                                            <br>• Кроме того, у нас появился чат - мы постараемся оперативно ответить на все Ваши сообщения. <br>• Помимо этого, были добавлены новые объявления и убраны неактуальные. Мы стремимся контактировать со всеми нашими клиентами для публикации только<a href="news/20.03.18.html#main-wrapper">...</a>
															</p>
														</div>
                                                    <br>
                                                </article>
